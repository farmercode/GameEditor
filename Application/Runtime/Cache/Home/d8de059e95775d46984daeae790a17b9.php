      ...
      <a href=""><i class="fa fa-suitcase"></i> <span>副本掉落</span></a>
	   ...
	   <li><a href="<?php echo U('Loot/lootList');?>"><span class="pull-right badge badge-danger">new</span>
          ...
          <li><a href="<?php echo U('Atlas/index');?>"> <span class="pull-right badge badge-danger">new</span>
                  <i class="fa fa-caret-right"></i>掉落组</a>
          </li>              
        </ul>  
        </li>
      ...
      <div class="col-md-12">          
          <div class="panel panel-info">
            ...
            <div class="panel-body">
               <a class="btn btn-warning" href="<?php echo U("Atlas/atlasLootAdd");?>" data-toggle="modal" data-target=".bs-example-modal-panel">添加掉落组</a>
               <a class="btn btn-pink" href="<?php echo U("Atlas/excelImport");?>" data-toggle="modal" data-target=".bs-example-modal-panel">导入掉落组</a>
               <a class="btn btn-white" href="<?php echo U("Atlas/exportToExcel");?>" style="float: right;">导出掉落组</a>
            </div>
          </div><!-- panel -->
        </div><!-- col-sm-6 -->
            ...
            <div class="table-responsive">
                <table class="table table-info mb30">
                    ...
                    <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$loot): $mod = ($k % 2 );++$k;?><tr>
                        <td><?php echo ($loot["atlasloot_id"]); ?></td>
                        <td><?php echo ($loot["atlasloot_name"]); ?></td>
                        <td class="loot_name"><?php echo ($loot["atlasloot_num"]); ?></td>                         
                        <td><?php echo ($loot["content"]); ?></td>
                        <td>
...
<div class="lootview" style="display:none;">
  ...
  <div class="view_search">搜索：<input type="text" /></div>
</div>
